                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " method="post" action="donneesPointscollecte.php">
                                

                                    <div class="form-group">
                                         <label class="col-sm-2 control-label">Adresse</label>
                                        <div class="col-sm-10">
                                        <input type="text" name="adress" class="form-control" placeholder="Saisir l'adresse">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="text" name="recovery_type" class="form-control" placeholder="Saisir le type de récuperation">
