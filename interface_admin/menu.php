              ...
              <ul class="sidebar-menu">               
				<?php
						  ...
						  <li class="sub-menu">
						   ...
						   <li class="sub-menu">
							...
							<li class="sub-menu">
							  ...
							  <ul class="sub">
								  <li><a class="" href="pick_up_point.php">Gestion point collecte</a></li>                          
                  ...
                  <li class="sub-menu">                     
                      ...
                      <ul class="sub">
                          <li><a class="" href="stats_user.php">Utilisateurs</a></li>                          
                          <!--<li><a class="" href="chart-chartjs.php">Annonces</a></li>-->
                          <!--<li><a class="" href="chart-chartjs.php">Récupération</a></li>        -->                  
                          <li><a class="" href="stats_geo.php">Stat géo</a></li>
                          <li><a class="" href="stats_biv.php">Comparaison variables</a></li>                        
                      </ul>                                         
                  </li>  
              </ul>
              <!-- sidebar menu end-->
